...
// Padrão verde água/branco/azul (estilo Connect-Med) — usado quando o
// tenant não configurou branding.primaryColor em config_per_client.
const DEFAULT_PRIMARY = "#008e95";
...
export function CentralAjuda() {
  ...
  return (
    <div
      className="min-h-screen bg-[#f8fdfe]"
    ...
    >
      <div className="mx-auto max-w-4xl space-y-6 p-6">
        ...
        <section className="max-w-md rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
